...
fontLoader.load(
    ...
    (font) => {
        const textGeometry = new TextGeometry("TERYOSHIN'S 3D DESIGN SCHOOL", {
            font,
            size: 0.5,
            height: 0.2,
            curveSegments: 12,
        ...
        ////TODO установка бокса геомтрии и смещение текстуры в центр сцены
        ...
        //TODO более простой вариант установки центра
        textGeometry.center();
